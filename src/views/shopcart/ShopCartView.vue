  ...
  <div>
    ...
    <div class="cart-box">
            ...
            <div class="good-item">
              ...
              <div class="good-desc">
                ...
                <div class="good-btn">
                  ...
                  <van-stepper :modelValue="item.num" integer :min="1" :max="item.goods.stock" :name="item.id" :step="1"
                  @change="onchange"/>
                </div>
              </div>
            </div>
            <template #right>
              <van-button @click="deleteGood(item.id)" style="height: 100%" square icon="delete" text="删除" type="danger" class="delete-button" />
            </template>
          </van-swipe-cell>
        </van-checkbox-group>
      </div>
      <van-submit-bar
          ...
          @submit="onSubmit"
        >
          <van-checkbox @click="allCheck" v-model:checked="checked">全选</van-checkbox>
        </van-submit-bar>
      <div class="empty" v-if="!list.length">
        <img src="~assets/images/empty-car.png" alt="空购物车" class="empty-cart">
